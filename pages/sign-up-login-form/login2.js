        ...
        if (emailInput && passwordInput) {
          ...
          try {
            ...
            if (response.status === 200) {
              ...
              const membershipResponse = await fetch("http://localhost:3000/getMembership", {
                method: "POST",
                headers: {
                  "Content-Type": "application/json",
                },
              ...
              // Extract membership type from the response
              const membershipData = await membershipResponse.json();
              const membershipType = membershipData.membershipType || "none";
  
              // Store user information and membership type in sessionStorage
              ...
              // Retrieve and log data from sessionStorage
              ...
              if (storedData) {
                ...
                console.log("MembershipType:", userData.membershipType);
              } else {
